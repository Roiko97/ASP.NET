<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Summarize.aspx.cs" Inherits="View.Summarize" EnableEventValidation="true" %>
...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow: hidden" runat="server">
    <div id="wrapper" runat="server">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <h2 class="text-center">Learn Git and GitHub without any code!</h2>
            <h3 class="text-center">Using the Hello World guide, you’ll create a repository, start a branch, write comments, and open a pull request.&nbsp;&nbsp;</h3>
