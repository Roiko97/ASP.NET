<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateCdt.aspx.cs" Inherits="test.WebForm4" %>
            ...
            <div class="wrapper wrapper-content">
                ...
                <form runat="server">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins setcolor">
                                <div class="ibox-txt">
                                    <h2 style="text-align: center">Markdown文本编辑器</h2>
                                </div>

                                <div class="ibox-content">
                                    <div class="md-editor">

                                        <div class="md-header btn-toolbar" id="doc" runat="server">
                                           <%-- <textarea name="content" data-provide="markdown" rows="10" class="md-input" style="resize: none; display: block;"></textarea>
                                    --%>    </div>
