<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Document.aspx.cs" Inherits="View.Document" %>
            ...
            <div class="row border-bottom">
                ...
                <div>
                    ...
                    <form id="form1" runat="server"  style="margin-top:0.5%; margin-left:20%;">
                        ...
                        <asp:TextBox style="height:300px" ID="txtEditorContents" name="txtEditorContents" runat="server" TextMode="MultiLine" Height="100px" Width="1000px" ClientIDMode="Static">
                            </asp:TextBox>
